...
module.exports = class BouncingBall extends MatrixApplication {
    static get name() { return 'Bouncing Ball Program by Stijn' }
    static get description() { 'And colours' }
    ...
    draw(deltaTime, time) {
        ...
        this.matrix.fgColor({
            ...
            g: 80,
            b: 0
        }).fill(this.ballx, this.bally, this.matrix.width(), this.matrix.height());
